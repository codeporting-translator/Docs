...
Version compatibility checker feature ensures that the set of enabled options is same between pre-built system libraries and all of the translated modules. See **version_compatibility_check_mode** option description in [[Configuration File Options|doc:Codeporting.Dynabic\.csPorter for Cpp.Documentation and Support Materials.Production documentation storage point.Developer Guide.CodePorting\.Translator Cs2Cpp configuration file.Configuration file options.WebHome]] section for more details.