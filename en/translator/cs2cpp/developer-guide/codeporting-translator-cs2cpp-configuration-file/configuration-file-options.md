...
| Allowed value | Meaning
---| ---|
| true | The translator builds the project passed to it and then translates it.
| false | The translator just translates the project passed to it without building it.
