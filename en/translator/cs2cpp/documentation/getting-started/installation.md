...
1. [Download the latest version.](https://products.codeporting.com/translator/csharp-to-cpp/release)
1. Unzip the folder to required location.
1. Get and install [free annual license.](https://www.codeporting.com/use-license)
1. Make sure the **ASPOSE_ROOT** environment variable contains the path to installation location (for example, "c:\aspose\csporter\cpp\asposecpplib").
