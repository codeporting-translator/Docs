...
The translated code can be built for x86, x64 and ARM platforms.
...
Both x64 and ARM platforms are supported.
...
All x86, x64 and ARM modes are supported.

### Linux ###

These are the requirements to run the translated code:

1. The Linux distribution for x86_64 platform (aka x64, aka AMD64, aka Intel 64) or ARM64, e. g. Ubuntu Linux or Debian Linux.
