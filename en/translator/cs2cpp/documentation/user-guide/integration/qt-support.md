...
Those customers who use both CodePorting.Translator and Qt, may use [helper functions](https://github.com/codeporting-translator/codeporting-translator-cs2cpp/tree/master/qt_helpers). Please click on below links for more information:
