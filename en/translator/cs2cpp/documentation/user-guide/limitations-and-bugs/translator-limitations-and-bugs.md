...
A concrete C# class that inherits an interface and does not implement one or more of the methods declared in it but instead inherits their implementation from a base class, will be translated into an abstract C++ class by default. Let us consider following C# class hierarchy
